...
namespace Nop.Core.Caching {
    ...
    public partial class MemoryCacheManager : ILocker, IStaticCacheManager {
        ...
        static MemoryCacheManager() => _allKeys = new ConcurrentDictionary<string, bool>();
        ...
        public virtual bool IsSet(string key) => _cache.TryGetValue(key, out object _);
        ...
        /// </summary>
        /// <param name="key">Key of cached item</param>
        public virtual void Remove(string key) => _cache.Remove(RemoveKey(key));
