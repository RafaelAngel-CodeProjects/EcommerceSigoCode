...
namespace Nop.Plugin.Shipping.FixedByWeightByTotal.Data {
    ...
    public class ShippingByWeightByTotalObjectContext : DbContext, IDbContext {
        ...
        public virtual IQueryable<TQuery> QueryFromSql<TQuery>(string sql) where TQuery : class => throw new NotImplementedException();
        ...
        public virtual void Detach<TEntity>(TEntity entity) where TEntity : BaseEntity => throw new NotImplementedException();
